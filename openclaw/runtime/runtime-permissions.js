...
const COMMAND_PERMISSIONS = {
  ...
  jarvis_session_start: {
    commands: ['/jarvis_session_start'],
    tier: 'state_mutation',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: true,
    ...
    publishesExternally: false,
    externalAction: false,
    capability: 'write_runtime',
    description: 'Start a Jarvis work session.'
  },
  jarvis_session_update: {
    commands: ['/jarvis_session_update'],
    tier: 'state_mutation',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: true,
    ...
    externalAction: false,
    capability: 'write_runtime',
    description: 'Update an active Jarvis work session.'
  },
  jarvis_session_done: {
    commands: ['/jarvis_session_done'],
    tier: 'state_mutation',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: true,
    ...
    externalAction: false,
    capability: 'write_runtime',
    description: 'Complete an active Jarvis work session.'
  },
  jarvis_session_status: {
    commands: ['/jarvis_session_status'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: 'Inspect status of active Jarvis work session.'
  },
  jarvis_session_latest: {
    commands: ['/jarvis_session_latest'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: 'Inspect latest Jarvis work sessions.'
  },
  jarvis_session_project: {
    commands: ['/jarvis_session_project'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: 'Inspect Jarvis work sessions for a project.'
  },
  jarvis_ingest_handoff: {
    commands: ['/jarvis_ingest_handoff'],
    tier: 'state_mutation',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: true,
    ...
    externalAction: false,
    capability: 'write_runtime',
    description: 'Ingest local docs/JARVIS_HANDOFF.md file.'
  },
  jarvis_brief: {
  ...
  prospect_status: {
    commands: ['/prospect_status', '/prospectstatus'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: 'Show prospect API configuration and status.'
  },
  prospect_search: {
    commands: ['/prospect_search', '/prospectsearch'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: true,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: 'Search and catalog local prospects in read-only mode.'
  },
  prospect_latest: {
    commands: ['/prospect_latest', '/prospectlatest'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: 'Show latest saved prospects.'
  },
  prospect_list: {
    commands: ['/prospect_list', '/prospectlist'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: 'Show recent saved prospects.'
  },
  prospect_read: {
    commands: ['/prospect_read', '/prospectread'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: 'Show safe details for a specific prospect.'
  },
  prospect_outreach: {
    commands: ['/prospect_outreach', '/prospectoutreach'],
    tier: 'generate_only',
    category: 'runtime_generation',
    requiresAdmin: true,
    mutatesState: true,
    ...
    externalAction: false,
    capability: 'generate_runtime',
    description: 'Handoff selected prospect to Hermes outreach generation queue.'
  },
  prospect_outreach_batch: {
    commands: ['/prospect_outreach_batch', '/prospectoutreachbatch'],
    tier: 'generate_only',
    category: 'runtime_generation',
    requiresAdmin: true,
    mutatesState: true,
    ...
    externalAction: false,
    capability: 'generate_runtime',
    description: 'Handoff multiple prospects in batch to Hermes outreach generation queue.'
  },
  outreach_status: {
    commands: ['/outreach_status', '/outreachstatus'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: 'Show manual outreach review status counts.'
  },
  outreach_list: {
    commands: ['/outreach_list', '/outreachlist'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: 'List recent manual outreach review records.'
  },
  outreach_read: {
    commands: ['/outreach_read', '/outreachread'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: 'Show detailed manual outreach drafts by review or prospect ID.'
  },
  outreach_mark: {
    commands: ['/outreach_mark', '/outreachmark'],
    tier: 'generate_only',
    category: 'runtime_generation',
    requiresAdmin: true,
    mutatesState: true,
    ...
    externalAction: false,
    capability: 'generate_runtime',
    description: 'Update manual status for a specific outreach review.'
  },
  outreach_note: {
    commands: ['/outreach_note', '/outreachnote'],
    tier: 'generate_only',
    category: 'runtime_generation',
    requiresAdmin: true,
    mutatesState: true,
    ...
    externalAction: false,
    capability: 'generate_runtime',
    description: 'Update operator notes for a specific outreach review.'
  },
  outreach_today: {
    commands: ['/outreach_today', '/outreachtoday'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: "List reviews where manual follow-up is due today or overdue."
  },
  outreach_due: {
    commands: ['/outreach_due', '/outreachdue'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: "List all manual reviews with follow-up scheduled."
  },
  outreach_pipeline: {
    commands: ['/outreach_pipeline', '/outreachpipeline'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: "Show manual outreach pipeline counts summary."
  },
  outreach_mark_contacted: {
    commands: ['/outreach_mark_contacted', '/outreachmarkcontacted'],
    tier: 'generate_only',
    category: 'runtime_generation',
    requiresAdmin: true,
    mutatesState: true,
    ...
    externalAction: false,
    capability: 'generate_runtime',
    description: "Log manual contact and increment count."
  },
  outreach_followup: {
    commands: ['/outreach_followup', '/outreachfollowup'],
    tier: 'generate_only',
    category: 'runtime_generation',
    requiresAdmin: true,
    mutatesState: true,
    ...
    externalAction: false,
    capability: 'generate_runtime',
    description: "Log follow-up schedule and set status."
  },
  research_prospect: {
    commands: ['/research_prospect', '/researchprospect'],
    tier: 'generate_only',
    category: 'runtime_generation',
    requiresAdmin: true,
    mutatesState: true,
    ...
    externalAction: false,
    capability: 'generate_runtime',
    description: "Enrich prospect details with website context."
  },
  research_read: {
    commands: ['/research_read', '/researchread'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: "Read detailed research findings for a prospect."
  },
  research_latest: {
    commands: ['/research_latest', '/researchlatest'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: "List the 5 most recently created research records."
  },
  research_status: {
    commands: ['/research_status', '/researchstatus'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: "Show research adapter registry status."
  },
  score_prospect: {
    commands: ['/score_prospect', '/scoreprospect'],
    tier: 'generate_only',
    category: 'runtime_generation',
    requiresAdmin: true,
    mutatesState: true,
    ...
    externalAction: false,
    capability: 'generate_runtime',
    description: "Evaluate prospect research and recommend outreach channel/offer."
  },
  score_read: {
    commands: ['/score_read', '/scoreread'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: "Read detailed scoring findings for a prospect."
  },
  score_latest: {
    commands: ['/score_latest', '/scorelatest'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: "List the 5 most recently created score records."
  },
  score_top: {
    commands: ['/score_top', '/scoretop'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: "List top 5 score records sorted by fitScore descending."
  },
  cockpit_today: {
    commands: ['/cockpit_today', '/cockpittoday'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: "Format daily cockpit overview card showing top prospects and follow-ups."
  },
  cockpit_top: {
    commands: ['/cockpit_top', '/cockpittop'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: "List top 10 ranked prospects with fit scores and recommended outreach channels."
  },
  cockpit_due: {
    commands: ['/cockpit_due', '/cockpitdue'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: "List prospects with follow-ups scheduled for today or overdue."
  },
  cockpit_next: {
    commands: ['/cockpit_next', '/cockpitnext'],
    tier: 'read_only',
    category: 'runtime_visibility',
    requiresAdmin: true,
    mutatesState: false,
    ...
    externalAction: false,
    capability: 'read_runtime',
    description: "List next 5 high-priority prospects to contact (not contacted yet)."
  }
};
...
function normalizeCommand(commandText) {
  ...
  const aliasMap = {
    ...
    'jarvissessionstart': 'jarvis_session_start',
    'jarvissessionupdate': 'jarvis_session_update',
    'jarvissessiondone': 'jarvis_session_done',
    'jarvissessionstatus': 'jarvis_session_status',
    'jarvissessionlatest': 'jarvis_session_latest',
    'jarvissessionproject': 'jarvis_session_project',
    'jarvisingesthandoff': 'jarvis_ingest_handoff',
    ...
    'prospectlatest': 'prospect_latest',
    'prospectlist': 'prospect_list',
    'prospectread': 'prospect_read',
    'prospectoutreach': 'prospect_outreach',
    'prospectoutreachbatch': 'prospect_outreach_batch',
    'outreachstatus': 'outreach_status',
    'outreachlist': 'outreach_list',
    'outreachread': 'outreach_read',
    'outreachmark': 'outreach_mark',
    'outreachnote': 'outreach_note',
    'outreachtoday': 'outreach_today',
    'outreachdue': 'outreach_due',
    'outreachpipeline': 'outreach_pipeline',
    'outreachmarkcontacted': 'outreach_mark_contacted',
    'outreachfollowup': 'outreach_followup',
    'researchprospect': 'research_prospect',
    'researchread': 'research_read',
    'researchlatest': 'research_latest',
    'researchstatus': 'research_status',
    'scoreprospect': 'score_prospect',
    'scoreread': 'score_read',
    'scorelatest': 'score_latest',
    'scoretop': 'score_top',
    'cockpittoday': 'cockpit_today',
    'cockpittop': 'cockpit_top',
    'cockpitdue': 'cockpit_due',
    'cockpitnext': 'cockpit_next'
  };
